 ...
 */
package com.uugty.uu.permission;
...
class PermissionUtils {
    ...
    static <T extends Annotation> boolean isSameRequestCode(Method method, Class<T> annotation, int requestCode) {
        ...
        else if (com.uugty.uu.permission.PermissionNo.class.equals(annotation))
            return method.getAnnotation(com.uugty.uu.permission.PermissionNo.class).value() == requestCode;
        return false;
    }
