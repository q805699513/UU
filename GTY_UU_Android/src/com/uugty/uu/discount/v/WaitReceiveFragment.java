...
public class WaitReceiveFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
	...
	private void loadData(final int what,final boolean isPull) {
		...
		params.add("couponUserStatus", "1"); // 待领取																		// 1游客
