...
public class OrderDetailTouristAdapter extends BaseAdapter {
		private Context context;
		private List<TouristEntity.Tourist> ls=new ArrayList<TouristEntity.Tourist>();

		public OrderDetailTouristAdapter(Context context, List<TouristEntity.Tourist> ls) {
			super();
		...
		public View getView(final int position, View view, ViewGroup parent) {
			...
			if(view==null){
				...
				view=LayoutInflater.from(context).inflate(R.layout.order_detail_tourist_item_layout, null);
