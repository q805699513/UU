...
//		dynamic_back.setVisibility(View.GONE);
		...
		Dynamic_release_text = (TextView) findViewById(R.id.Dynamic_release_text);
		...
		adapter = new FriendsAdapter(ctx, list);
		mListView.setAdapter(adapter);
	}

	@Override
	protected void initAction() {
		dynamic_back.setOnClickListener(new OnClickListener() {
...
//					intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
	...
	private void loadData(final int what) {
		...
		APPRestClient.post(FriendsDynamicActivity.this, ServiceCode.DYNAMIC_DETAILS, params,
				new APPResponseHandler<DynamicEntity>(DynamicEntity.class,
					...
					public void onFailure(int errorCode, String errorMsg) {
						if (errorCode == 3) {
							...
							CustomToast.makeText(FriendsDynamicActivity.this, 0, errorMsg,
									300).show();
							mSwipeLayout.setRefreshing(false);
							if (errorCode == -999) {
...
//				context.startActivity(intent);
	...
	static class ViewHolder {
		...
		LinearLayout dynamic_photo_show, dynamic_praise_rel,
				...
				dynamic_browse_rel, dynamic_postion_item_lin;
