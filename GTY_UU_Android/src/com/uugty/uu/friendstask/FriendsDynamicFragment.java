...
public class FriendsDynamicFragment extends Fragment implements
	...
	protected void initGui() {
		...
		mSwipeLayout = (SwipeRefreshLayout) rootview
				.findViewById(R.id.dynamic_swipe_container);
		Dynamic_release_text = (TextView) rootview
				.findViewById(R.id.Dynamic_release_text);
	...
	private void loadData(final int what) {
		...
		APPRestClient.post(getActivity(), ServiceCode.DYNAMIC_DETAILS, params,
