...
import com.uugty.uu.shop.guide.adapter.GuideSearchAutoAdapter;

import java.util.ArrayList;
import java.util.Arrays;

@SuppressLint("ViewConstructor")
public class GuideSearchPopuWindow extends Activity {
	public static final String SEARCH_HISTORY = "guide_search_history";
	/**
	 * 搜索框
	 */
	...
	private GuideSearchAutoAdapter mSearchAutoAdapter;
	private View footer;
	...
	private void initWidget() {
		mSearchAutoAdapter = new GuideSearchAutoAdapter(this, -1);
