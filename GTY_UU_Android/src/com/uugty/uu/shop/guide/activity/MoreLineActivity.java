	...
	private void moreList(final List<MoreListEntity> result) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// TODO Auto-generated method stub
				ActivityCollector.removeSpecifiedActivity("com.uugty.uu.shop.guide.activity.RoadDetailActivity");
				Intent intent=new Intent();
				intent.putExtra("roadId",morelv.get(position).getRoadlineId());
				intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
				intent.setClass(MoreLineActivity.this, RoadDetailActivity.class);
