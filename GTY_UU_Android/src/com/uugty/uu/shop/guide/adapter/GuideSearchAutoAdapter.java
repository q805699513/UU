...
import com.uugty.uu.common.myview.SearchAutoData;
import com.uugty.uu.shop.guide.activity.GuideSearchPopuWindow;

import java.util.ArrayList;
import java.util.List;

@SuppressLint("DefaultLocale")
public class GuideSearchAutoAdapter extends BaseAdapter {
	...
	public GuideSearchAutoAdapter(Context context, int maxMatch) {
	...
	public void initSearchHistory() {
		SharedPreferences sp = mContext.getSharedPreferences(
				GuideSearchPopuWindow.SEARCH_HISTORY, 0);
		String longhistory = sp.getString(GuideSearchPopuWindow.SEARCH_HISTORY, "");
	...
	public void clear() {
		SharedPreferences sp = mContext.getSharedPreferences(
				GuideSearchPopuWindow.SEARCH_HISTORY, 0);
		sp.edit().putString(GuideSearchPopuWindow.SEARCH_HISTORY, "").commit();
		mObjects = null;
