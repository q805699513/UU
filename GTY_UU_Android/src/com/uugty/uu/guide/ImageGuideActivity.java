...
public class ImageGuideActivity extends BaseActivity {
	...
	protected void initGui() {
		...
		pageViews.add(inflater.inflate(R.layout.image_guide_viewpage_one, null));
		pageViews.add(inflater.inflate(R.layout.image_guide_viewpage_two, null));
		pageViews.add(inflater.inflate(R.layout.image_guide_viewpage_three, null));
		// 创建imageviews数组，大小是要显示的图片的数量
		imageViews = new ImageView[pageViews.size()];
		// 从指定的XML文件加载视图
		viewPics = (ViewGroup) inflater.inflate(R.layout.image_guide, null);

		// 实例化小圆点的linearLayout和viewpager
		viewPoints = (ViewGroup) viewPics.findViewById(R.id.image_guide_point_viewGroup);
		viewPager = (ViewPager) viewPics.findViewById(R.id.image_guide_viewpager);
		viewPointLin=(FrameLayout) viewPics.findViewById(R.id.image_guide_point_lin);
	...
	private Button.OnClickListener Button_OnClickListener = new Button.OnClickListener() {
		public void onClick(View v) {
			...
			mIntent.setClass(ImageGuideActivity.this, MainActivity.class);
			ImageGuideActivity.this.startActivity(mIntent);
		}
	};
