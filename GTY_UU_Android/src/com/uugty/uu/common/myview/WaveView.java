...
public class WaveView extends LinearLayout {
	...
	private float drawingRadiusDegrees = 5;//慢慢绘制圆环的时候，半径的递增百分比
	private static final long INVALID_DURATION = 20;
	private postUpEventDelayed delayedRunnable;
	public void init() {
		setOrientation(VERTICAL);
		mHalfTransPaint = new Paint();
		mHalfTransPaint.setColor(Color.parseColor("#5598999a"));
		mHalfTransPaint.setAntiAlias(true);//给Paint加上抗锯齿标志
		mTransPaint = new Paint();
		mTransPaint.setColor(Color.parseColor("#0098999a"));
