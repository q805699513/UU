package com.uugty.uu.common.pullzoomview;
...
public class PullToZoomScrollViewEx extends PullToZoomBase<ScrollView> {
	...
	private OnPullScrollViewListener mOnScrollViewListener;
	...
	public interface OnPullScrollViewListener {
		void onPullScrollChanged(PullToZoomScrollViewEx v, int l, int t, int oldl,
				int oldt);
	}

	public void setOnPullScrollViewListener(OnPullScrollViewListener l) {
		this.mOnScrollViewListener = l;
	}

	protected void onPullScrollChanged(int l, int t, int oldl, int oldt) {
		super.onScrollChanged(l, t, oldl, oldt);
		if (mOnScrollViewListener != null) {
			mOnScrollViewListener.onPullScrollChanged(this, l, t, oldl, oldt);
		}
